...
#          --render_vcam --n_vcam 6 --seed=0 --r_scale 0.1 --test_idxs 36

# train vcurf

python active_vcurf.py -s ${DATASET_PATH}/${OBJ} -m ${EXP_PATH}/${OBJ}/activevcurf4/ --train_idxs ${OBJ} --eval \
            --method=vcam --seed=0 --schema vk --n_inits 15 --n_vcam 6 --r_scale 0.1 \
            --iterations 30000 --save_iterations 2000 5000 10000 15000 20000 25000 30000\
            --test_iterations 2000 5000 10000 15000 20000 25000 30000\
            --checkpoint_iterations 100 5000 10000 20000 25000 30000
