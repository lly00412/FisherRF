...
do
    ...
    echo python active_train.py -s ${SCENE_PATH} -m ${MODEL_PATH} --eval --method=mlp --seed=${SEED} --schema v20seq4_inplace --iterations 20000 --run_time ${RUN_TIME}
