...
#EXP_PATH=./output/nerf_synthetic_debug
...
do
    ...
    python active_train.py -s ${SCENE_PATH} -m ${MODEL_PATH} --eval --method=vcurf --seed=0 --schema vk \
           --iterations 30000 --n_vcam=8 --r_scale=0.3 --run_time ${RUN_TIME} --white_background  --n_inits 20
